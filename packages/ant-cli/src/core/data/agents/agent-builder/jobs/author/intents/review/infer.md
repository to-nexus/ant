...
---
A finished agent definition is to be judged rather than changed — against the material it was authored from when that is in hand, against the authoring contract always — and the verdict must outlive the chat as a report.
