...
export interface PromptLogEntry {
  ...
  callIndex?: number;
  timestamp: string;
  /** Main template file path (e.g., 'jobs/design/nodes/execute/variants/ui-design-by-desc/base') */
  templatePath?: string;
...
export class PromptLogger {
  ...
  constructor(options: PromptLoggerOptions) {
    ...
    const agent = options.jobType === 'plan' ? 'planner'
                : options.jobType === 'visual' ? 'creator'
                : 'architect';
 ...
 *   - templatePath: Main template file (e.g., 'jobs/design/nodes/execute/variants/ui-design-by-desc/base')
