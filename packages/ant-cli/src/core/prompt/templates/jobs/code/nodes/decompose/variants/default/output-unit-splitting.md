...
**Constraint — priority**: Per-unit ui tasks use priority in the 650–749 range. Distinguishability between ui tasks comes from `parallelGroup` (which matches the paired feature), not from priority.
