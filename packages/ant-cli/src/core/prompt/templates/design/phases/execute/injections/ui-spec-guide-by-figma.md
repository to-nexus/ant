...
**Default: Extract from Figma Design Context First**

Your primary task is to extract and document what Figma design data SHOWS.
...
**Not explicit (follow Figma data):**
...
**Principle**: Extract from Figma design context first, unless explicitly overridden by written specifications.
...
> ⚠️ **This is minimum structure, not exhaustive.** Document ALL properties extracted from Figma design context. If you find border-radius, shadows, gradients, animations, or any other visual property — add it.
...
**⚠️ EXTRACT from Figma design context for EVERY container:**
