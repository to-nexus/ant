...
interface DetectEnvironmentResponse {
  ...
  decomposeKeywords: {
    stackTrace: string[];  // ✅ Stack trace files (exact names)
...
export async function detectEnvironment(
  ...
  // ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
  // 6. Log Results & Display in Chat UI
  // ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
  ...
  if (parsed.requireRagForDecompose && (decomposeKeywords.stackTrace.length > 0 || decomposeKeywords.keywords.length > 0)) {
    // ✅ Console log
    ...
    // ✅ Display in Chat UI
    let keywordDisplay = '🔑 **Decompose Search Keywords**\n\n';
