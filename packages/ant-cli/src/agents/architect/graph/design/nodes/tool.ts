  ...
  try {
    ...
    switch (name) {
      ...
      case 'list_assets':
        ...
        break;
      // ✅ NEW: Reference project search (for system-design with reference repos)
...
// ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
// REFERENCE PROJECT TOOLS (for system-design)
// ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
 ...
 * 
 * This is the Design Job version, adapted from Code Job's implementation.
 * Used when directive mentions a reference repo to analyze for API contracts, etc.
 */
...
- Searching for broader concepts (e.g., "API endpoints" instead of specific method names)`;
    ...
    // 6. Update UI: Show search complete + explored files
    ...
    // 7. Format result
    return `Retrieved ${searchResult.stats.filesLoaded} relevant file(s) from reference project "${project}":

${searchResult.code}

**Note:** This code is from the reference project "${project}". Use it to understand APIs, data structures, and implementation patterns for your design document. Do NOT include implementation details - focus on API contracts and interfaces.`;
