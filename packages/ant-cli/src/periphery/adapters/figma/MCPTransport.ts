...
// Unwrap helpers are transport-agnostic and shared with the universal-job MCP
// client — the SSOT lives in core/utils/mcpContent.ts; re-exported here for
// the existing figma-side callers.
export { extractMCPTextContent, extractMCPImageContent } from '../../../core/utils/mcpContent';
