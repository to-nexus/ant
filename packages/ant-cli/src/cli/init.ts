...
`;
  ...
  // Create placeholder files that will be overwritten
  const uiSpecTemplate = `{
  "_comment": "ant:template - 디자인 잡 실행 시 자동 생성됩니다. Run 'ant design' to generate.",
  "placeholder": true
}
`;
  fs.writeFileSync(path.join(designOutputDir, "ui-spec.json"), uiSpecTemplate, "utf8");
...
`;
  fs.writeFileSync(path.join(designOutputDir, "ui-tokens.json"), uiTokensTemplate, "utf8");
...
`;
  fs.writeFileSync(path.join(designOutputDir, "ui-assets.json"), uiAssetsTemplate, "utf8");
...
`;
  ...
  console.log(`  - outputs/design/ui-spec.json (placeholder - auto-generated)`);
  console.log(`  - outputs/design/ui-tokens.json (placeholder - auto-generated)`);
  console.log(`  - outputs/design/ui-assets.json (placeholder - auto-generated)`);
