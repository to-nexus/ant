...
`;
  ...
  // NOTE: Design documents are auto-generated by Design Job into canonical subdirectories:
  //   outputs/design/ui/ant/ — ui-spec.json, ui-tokens.json, ui-assets.json (ant UiSource SSOT)
  //   outputs/design/system/ — be-system-*.md, fe-system-*.md, api-contract-*.md
  //   outputs/design/spec/   — spec-*.md
