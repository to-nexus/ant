...
describe('Audit 2C: deriveFromIntent — intent → derived values', () => {
  const EXPECTED_DERIVATIONS: Array<{
    ...
    { intent: 'gen-art-figma', mode: 'generate', agent: 'architect', jobType: 'design', intentGroup: 'design-art' },
    { intent: 'gen-art-ref', mode: 'generate', agent: 'architect', jobType: 'design', intentGroup: 'design-art' },
    { intent: 'gen-art-desc', mode: 'generate', agent: 'architect', jobType: 'design', intentGroup: 'design-art' },
    { intent: 'rev-art', mode: 'refactor', agent: 'architect', jobType: 'design', intentGroup: 'design-art' },
    { intent: 'explain-art', mode: 'explain', agent: 'architect', jobType: 'design', intentGroup: 'design-art' },
