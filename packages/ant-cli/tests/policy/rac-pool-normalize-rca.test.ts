/**
 * RAC-pool path-normalize RCA — basis pre-fetch + plan-rag normalize SSOT.
 *
 * The original failure (logged in
 * `to.nexus/probe/gamehub-fe/features/base/sessions/chat.jsonl` at
 * lines 6072–6076 of rac-pool-normalize turn t-fac11e3c):
 *
...
// ─────────────────────────────────────────────────────────────────────
// Shared fixture — mimics the rac-pool-normalize workspace shape:
...
describe('rac-pool-normalize — common read_file resolves raw apps/ path', () => {
...
describe('rac-pool-normalize — decompose RAC gate dispatches via normalize SSOT', () => {
...
describe('rac-pool-normalize — keyword normalizePathArray cleans LLM JSON', () => {
