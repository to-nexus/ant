...
const DIR_DESCRIPTIONS: DirDescription[] = [
  ...
  { path: 'outputs/design/ui/handoff', description: { en: 'Free-form handoff bundle — html/css/md/json/png. No schema is assumed; contents are observed directly during code generation.', ko: '자유 형식 핸드오프 번들 — html/css/md/json/png. 스키마를 가정하지 않으며 코드 생성 시 내용을 그대로 관찰합니다.' } },
