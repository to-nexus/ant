export function RetroFuturePreview({ className = '' }: { className?: string }) {
  ...
  return (
    <div className={`${base} bg-cyan-50 p-1 gap-0.5`}>
      <div className="h-1 w-5 bg-aurora-teal-400 rounded-full" />
  ...
  return (
    <div className={`${base} bg-cyan-50`}>
      ...
      <div className="flex items-center px-3 py-2 border-b border-cyan-200/50">
        <div className="h-2 w-10 bg-aurora-teal-500 rounded-full" />
      ...
      <div className="p-3 flex flex-col gap-2">
        <div className="h-3.5 w-2/3 bg-aurora-teal-300/50 rounded-full" />
        <div className="flex gap-1.5">
          <div className="flex-1 h-12 rounded-2xl bg-gradient-to-r from-teal-200 to-cyan-200 p-2">
            <div className="h-1.5 w-8 bg-aurora-teal-400/60 rounded-full" />
            <div className="h-1 w-5 bg-aurora-teal-500/30 rounded-full mt-1" />
          </div>
