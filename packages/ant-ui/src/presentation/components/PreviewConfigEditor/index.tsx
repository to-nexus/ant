    ...
    <div className="h-full overflow-y-auto">
      <div className="max-w-2xl mx-auto p-6 space-y-6">
        ...
        <section className="rounded-lg border border-gray-200 dark:border-gray-700 p-4">
          ...
          {/* Deploy status */}
          <div className="flex items-center gap-2 mb-3">
            {deployStatusData?.phase === 'running' ? (
              <div className="flex items-center gap-1.5">
            ...
            ) : deployStatusData?.phase === 'building' ? (
              <div className="flex items-center gap-1.5">
                <Loader2 className="w-4 h-4 text-blue-500 animate-spin" />
                <span className="text-sm font-medium text-blue-700 dark:text-blue-300">
            ...
            ) : deployStatusData?.phase === 'deploying' ? (
              <div className="flex items-center gap-1.5">
                <Loader2 className="w-4 h-4 text-blue-500 animate-spin" />
                <span className="text-sm font-medium text-blue-700 dark:text-blue-300">
          ...
          <div className="flex items-center gap-2">
            ...
            {deployStatusData?.phase === 'running' && deployStatusData?.url && (
              <button
                onClick={openDeployUrl}
                className="flex items-center gap-1.5 px-4 py-2 text-xs font-medium rounded-md
                         bg-blue-600 text-white hover:bg-blue-700
                         transition-colors"
              >
          ...
          {/* Deploy error */}
          {deployStatusData?.phase === 'error' && deployStatusData?.error && (
            <div className="mt-3 p-3 bg-red-50 dark:bg-red-950/30 border border-red-200 dark:border-red-800 rounded-md">
              <p className="text-sm text-red-700 dark:text-red-300">{deployStatusData.error}</p>
            </div>
          )}
