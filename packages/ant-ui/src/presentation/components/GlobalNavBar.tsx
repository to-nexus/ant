              ...
              <>
                ...
                {!isSignedIn ? (
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <a
                      href={`${import.meta.env.VITE_CLOUD_BACKEND_BASE?.replace('/api', '') || 'http://localhost:4100'}/api/auth/google`}
                      className="px-4 py-1.5 text-sm font-semibold text-gray-700 dark:text-gray-200
