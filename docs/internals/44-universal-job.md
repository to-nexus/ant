...
by the control-plane poller and never shown to a model — bound to a job's
`apis` entry or carried inline on the trigger, connectivity only either way —
doc 46 §2.) It is prose:
